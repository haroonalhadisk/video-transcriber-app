...
from batch_instagram_integration import extend_instagram_integration
...
For advanced usage, see: https://instaloader.github.io/
        ...
        # Extend with batch Instagram processing functionality
        extend_instagram_integration(gui_instance)
